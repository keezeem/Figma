...
import join from "../assets/join.png"; // Background image
import group from "../assets/group.png"; // Group image
...
const Exploring = () => {
  return (
    <div
      className="w-full max-w-[1300px] min-h-[700px] rounded-3xl shadow-lg mt-24 mb-24 overflow-hidden mx-auto flex flex-col md:flex-row items-center px-6 md:px-8 lg:px-12 relative"
      style={{
    ...
    >
      ...
      <div className="w-full md:w-1/3 lg:w-1/2 flex justify-center md:justify-end mt-6 md:mt-0">
