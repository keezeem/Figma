...
const HeroSection = () => {
  return (
    <div
      ...
      style={{ backgroundImage: `url(${hero})` }} // Corrected the style prop for background image
    >
      {/* Left Section */}
      <div className="flex-1 p-6 flex flex-col justify-center rounded-lg">
        ...
        <div className="flex gap-4 px-10 mt-10">
          ...
          <button className="py-2 px-4 sm:px-6  text-white text-sm ring-2 ring-white font-medium rounded-full shadow hover:bg-gray-300 transition">
            Sign Up
          </button>
        </div>
      </div>
