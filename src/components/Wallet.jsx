...
const navigation = [
  { name: 'Create new project', href: '#', icon: PlusCircleIcon, current: false },
  { name: 'Dashboard', href: '#', icon: HomeIcon, current: true },
  { name: 'Wallet', href: '#', icon: WalletIcon, current: false },
  { name: 'Upgrade', href: '#', icon: CheckBadgeIcon, current: false },
  { name: 'Trade', href: '#', icon: CalendarIcon, current: false },
  { name: 'Transaction History', href: '#', icon: ClockIcon, current: false },
